    ...
    <v-card flat tile class="black white--text py-12 px-5" width="100%">
      <v-row>
        <v-col cols="12" xs="12" sm="6" md="4" class="pa-16">
          <v-toolbar color="transparent" flat>
            <v-badge color="#D5F0DB" dot>
              <v-img src="logo.png" contain width="30"></v-img>
            </v-badge>

            <v-toolbar-title class="ml-4">
              <strong>Cookie</strong><span class="green--text">&</span
              ><strong>Soda</strong>
            </v-toolbar-title>
          </v-toolbar>
        ...
        <v-col cols="12" xs="12" sm="6" md="4">
          ...
          <v-card-text class="grey--text"> South Africa </v-card-text>
          <v-card-text class="grey--text mt-n4"> Cape Town </v-card-text>
          <v-card-text class="grey--text mt-n4"> cookiesoda.come </v-card-text>
          <v-card-text class="grey--text mt-n4"> +27 00 000 0000 </v-card-text>
        </v-col>
      </v-row>
    </v-card>
  </v-footer>
